...
public class LLAPPublicGrading {
	...
	public void testa0() throws Exception {
		...
		solution =solution.replace(" ", ""); System.out.println(solution);
		LLAPPlanChecker pc = new LLAPPlanChecker(initialState0);
		printResourceUtilization("Test" );
...
//	    solution =solution.replace(" ", ""); System.out.println(solution);
//	    LLAPPlanChecker pc = new LLAPPlanChecker(initialState4);
//					printResourceUtilization("Test Number E4" );;
//assertTrue("The output actions do not lead to a goal state.", pc.applyPlan(initialState4, solution));
//	}
//	@Test(timeout = 120000)
...
//		solution =solution.replace(" ", ""); System.out.println(solution);
//		LLAPPlanChecker pc = new LLAPPlanChecker(initialState9);
//					printResourceUtilization("Test Number E9" );;
//assertTrue("The output actions do not lead to a goal state.", pc.applyPlan(initialState9, solution));
//	}
//	@Test(timeout = 120000)
...
//		solution =solution.replace(" ", ""); System.out.println(solution);
//		LLAPPlanChecker pc = new LLAPPlanChecker(initialState10);
//					printResourceUtilization("Test Number E10" );;
//assertTrue("The output actions do not lead to a goal state.", pc.applyPlan(initialState10, solution));
//	}
//	@Test(timeout = 120000)
...
//	    solution =solution.replace(" ", ""); System.out.println(solution);
//	    LLAPPlanChecker pc = new LLAPPlanChecker(initialState4);
//					printResourceUtilization("Test Number F4" );;
//assertTrue("The output actions do not lead to a goal state.", pc.applyPlan(initialState4, solution));
//	}
//	@Test(timeout = 120000)
...
//		solution =solution.replace(" ", ""); System.out.println(solution);
//		LLAPPlanChecker pc = new LLAPPlanChecker(initialState9);
//					printResourceUtilization("Test Number F9" );;
//assertTrue("The output actions do not lead to a goal state.", pc.applyPlan(initialState9, solution));
//	}
//	@Test(timeout = 120000)
...
//	}
	...
	public void printResourceUtilization(String testName) {
	        // Get CPU time
	        ThreadMXBean threadMXBean = ManagementFactory.getThreadMXBean();
	        long cpuTimeNano = threadMXBean.getCurrentThreadCpuTime();
	        double cpuTimeMillis = cpuTimeNano / 1e6; // Convert nanoseconds to milliseconds
	        ...
	        System.out.printf("%s - CPU Time: %.3f ms\n", testName, cpuTimeMillis);
	        System.out.printf("%s - Memory Usage: %.2f MB\n", testName, memoryUsageMB);
	    }
